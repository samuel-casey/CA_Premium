...
var allStationCoordinates = [{'lat':'30.279','lon':'-87.555'},
...
function handleSubmit() {
    ...
    const nextTide = document.querySelector('#nextTideTime');
    const previousTide = document.querySelector('#previousTideTime');
